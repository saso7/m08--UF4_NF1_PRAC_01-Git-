...
<body>
    <div class="header-separator">
        <div class="header-main">
            <div class="header-logo">
                <img src="{{ asset('images/logo-no-back.png') }}" width = "300" alt="description of myimage">
            </div>
            ...
            @if (Route::has('login'))
                    @auth
                        ...
                        <div class="header-basket">
                            ...
                            <a href="" class="header-links">Basket</a>
                        </div>
                    @else
    ...
    <div class="main">
        <img class="image-offers" src="{{ asset('images/flash_offer.png') }}" alt="flash_offers"></img>
        <img class="image-offers" src="{{ asset('images/bestSellers.png') }}" alt="Girl in a jacket"></img>
        <img class="image-offers" src="{{ asset('images/2nd_hand.png') }}" alt="Girl in a jacket"></img>
        <img class="image-offers" src="" alt="Not ready yet"></img>
    </div>
